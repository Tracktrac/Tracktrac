...
const SixMonthRecap = () => {
  const { topTracks, setLimit: setTracksLimit } = useTopTracks('medium_term');
  const { topArtists, setLimit: setArtistsLimit } = useTopArtists('medium_term');
  const { topAlbums, setLimit: setAlbumsLimit } = useTopAlbums('medium_term');
  ...
  if (loading) return <Loading message="Loading your 6-month recap..." />;
  ...
  const sections = [
    { 
      ...
      data: topTracks,
      icon: MusicNote,
      description: 'Your most played tracks these 6 months',
    ...
    { 
      ...
      data: topAlbums,
      icon: Album,
      description: 'Your favorite albums these 6 months',
