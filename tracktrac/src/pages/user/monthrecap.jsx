...
const MonthRecap = () => {
  const { topTracks, setLimit: setTracksLimit } = useTopTracks('short_term');
  const { topArtists, setLimit: setArtistsLimit } = useTopArtists('short_term');
  const { topAlbums, setLimit: setAlbumsLimit } = useTopAlbums('short_term');
  ...
  if (loading) return <Loading message="Loading your monthly recap..." />;
  ...
  const sections = [
    ...
    { 
      ...
      data: topAlbums,
      icon: Album,
      description: 'Your favorite albums this month',
      ...
      <Box sx={styles.header}>
        ...
        >
          ...
          <Typography sx={styles.subtitle} variant="h6">
            Hey {profileData?.display_name}! Here's what you've been loving this month.
          </Typography>
        </motion.div>
      </Box>
